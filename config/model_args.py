...
class UdopModelArguments:
    ...
    backbone_weights_prefix: str = field(
        default=None, metadata={"help": "Prefix of path to visual backbone weights"}
    )
    ...
    num_attention_seq_chunk: int = field(default=1)
    embedding_2dpos_type: str = field(
        default="embed",
        metadata={"help": "embed,sin,none"},
    )
    embedding_use_mlp: bool = field(default=False)
    embedding_skip_connect: bool = field(default=False)
    embedding_1dpos_type: str = field(
        default="embed",
        metadata={"help": "same as embedding_2dpos_type"},
    )
    embedding_use_hw: bool = field(default=False)
