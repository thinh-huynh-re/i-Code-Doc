...
class UdopDataArguments:
    ...
    train_file: str = field(
        default=None,
        metadata={"help": "Filename of the .json file for the SQuAD task train set."},
    )
    dev_file: str = field(
        default=None,
        metadata={"help": "Filename of the .json file for the SQuAD task dev set."},
    )
    test_file: str = field(
        default=None,
        metadata={"help": "Filename of the .json file for the SQuAD task test set."},
    )
    ...
    max_seq_length_decoder: int = field(
        default=512,
        metadata={
            "help": "The maximum total input sequence length after tokenization for decoder. Sequences longer "
            "than this will be truncated, sequences shorter will be padded."
        },
    )
    ...
    whole_word_masking: bool = field(
        default=False, metadata={"help": "Whether to do whole word masking in mlm"}
    )
    mask_mlm_tokens: bool = field(
        default=True,
        metadata={
            "help": "Whether to mask image area corresponding to tokens masked in mlm"
        },
    )
    mlm_tokens_mask_method: str = field(
        default="black",
        metadata={"help": 'chosen in `["black", "random_grey"]`, default: `"black"`'},
    )
    ...
    use_line_tokens: bool = field(default=False)
    cache_blob_json: bool = field(default=False)
    do_supervised: bool = field(
        default=False,
        metadata={"help": "do supervised tasks on lang"},
    )
    do_selfsupervised: bool = field(
        default=False,
        metadata={"help": "do self supervised tasks on lang"},
    )
    do_selfsupervised_vis: bool = field(
        default=False,
        metadata={"help": "do self supervised vision tasks"},
    )
    publaynet_dir: str = field(
        default="publaynet",
        metadata={"help": "publaynet directory"},
    )
    websrc_dir: str = field(
        default="websrc",
        metadata={"help": "websrc directory"},
    )
    docbank_dir: str = field(
        default="docbank",
        metadata={"help": "docbank directory"},
    )
    ...
    duebenchmark_dir: str = field(
        ...
        metadata={"help": "duebenchmark directory"},
    )
    rvlcdip_dir: str = field(
        default="rvl-cdip",
        metadata={"help": "rvlcdip directory"},
    )
    mpdfs_dir: str = field(
        default=".",
        metadata={"help": "mpdfs directory"},
    )
    mae_version: str = field(
        default=".",
        metadata={"help": "mae version"},
    )
    mae_checkpoint: str = field(
        default=".",
        metadata={"help": "mae checkpoint"},
    )
