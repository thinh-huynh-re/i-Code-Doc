    ...
    def __init__(
        ...
        **kwargs
        ...
        self.context_embeddings = (
            [] if context_embeddings is None else context_embeddings
        )
        self.relative_bias_args = (
            [] if relative_bias_args is None else relative_bias_args
        )
        self.vision_augmentation = (
            [] if vision_augmentation is None else vision_augmentation
        )
        self.page_embeddings_type = page_embeddings_type
        self.page_embeddings_args = (
            {} if page_embeddings_args is None else page_embeddings_args
        )
